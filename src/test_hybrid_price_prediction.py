"""
Simple script to test the dynamic watchlist and price prediction functionality
"""
...
# Create a simple mock for streamlit
class MockSt:
    def error(self, msg):
        print(f"ERROR: {msg}")
...
def test_price_prediction():
    ...
    for ticker in tickers:
        print(f"\nTesting price prediction for {ticker}:")
        prediction = predict_price_range(ticker)
